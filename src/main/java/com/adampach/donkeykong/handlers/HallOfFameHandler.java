...
public class HallOfFameHandler implements EventHandler<ActionEvent>, Subject<Observer<GameEventEnums.GameEvents>> {
    ...
    {
        observers.forEach( o -> o.notifyObserver(GameEventEnums.GameEvents.HallOfFame));
    }
}