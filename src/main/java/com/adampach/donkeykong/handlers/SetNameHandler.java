...
public class SetNameHandler implements EventHandler<ActionEvent>, Subject<Observer<GameEventEnums.GameEvents>> {
    ...
    {
        observers.forEach( o -> o.notifyObserver(GameEventEnums.GameEvents.SetName));
    }
}